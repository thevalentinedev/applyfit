...
import { refineSection } from "@/lib/section-refiner"
...
export function EditableSection({
  ...
  const handleRefine = async () => {
    ...
    try {
      ...
      let errorMessage = "Failed to refine section. Please try again."
  ...
  const handleRefineBullet = async () => {
    ...
    setIsRefining(true)
    try {
      const { refineBullet } = await import("@/lib/section-refiner")

      const refinedContent = await refineBullet(
        editedContent,
        sectionContext.jobDescription,
        sectionContext.jobTitle,
        sectionContext.companyName,
